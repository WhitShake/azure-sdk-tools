    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            CreateMap<UserPreferenceModel, UserPreferenceModel>()
                ...
                .ForMember(dest => dest.UnsubscribeFromEmails, opt => opt.MapFrom((src, dest) => src._unsubscribeFromEmails != null ? src._unsubscribeFromEmails : dest._unsubscribeFromEmails));
        }
    }
}
